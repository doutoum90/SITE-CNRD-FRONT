...
import { Article, ArticlePagine, Pagination } from "../model/article.model";
...
export class ArticleCatComponent implements OnInit {
  ...
  pageArchived: Pagination = { count: 0, pageSize: 5, limit: 5, offset: 1 };
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.articles$ = this.articleService.getArticlesByCat(
      catId,
      this.pageArchived
    );
